...
const routes: RouteRecordRaw[] = [
  ...
  { path: "/mcp-servers/new", name: "mcp-server-new", component: () => import("./views/McpServerDetailView.vue"), props: { isNew: true } },
  { path: "/mcp-servers/:name", name: "mcp-server-detail", component: () => import("./views/McpServerDetailView.vue"), props: true },
