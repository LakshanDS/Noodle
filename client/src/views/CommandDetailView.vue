      ...
      <aside class="side-col">
        ...
        <Card title="Template tags">
          ...
          <div class="tag-list">
            ...
            <div class="tag-row"><code class="inline mono">{pr.0}</code> — nth open PR title (0-indexed).</div>
            <div class="tag-row"><code class="inline mono">{issue}</code> — All open issue titles, one per line.</div>
            <div class="tag-row"><code class="inline mono">{issue.0}</code> — nth open issue title (0-indexed).</div>
          </div>
        </Card>
      </aside>
