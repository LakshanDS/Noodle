...
const SECTIONS = [
  { key: "github", title: "GitHub", icon: "github" as IconName, desc: "Credentials the agent uses to clone, push, and open PRs. Restart required after changing." },
...
function sectionOf(meta: SettingMeta): string {
  if (meta.key.startsWith("GITHUB_")) return "github";
